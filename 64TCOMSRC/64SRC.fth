...
: TSRC-ABORTQ?  ( ca u -- f )
  ...
  OVER 5 S" ABORT" TSRC-EQ 0= IF  2DROP FALSE EXIT  THEN
  DROP 5 + C@ TSRC-QUOT =
  ;

: TSRC-COMPILE-ABORTQ  ( -- )
  S" TIF" TSRC-HOST-EXEC
  TSRC-COMPILE-STRING
  S" ETYPE#" TSRC-LIB-CALL
  -1 G,
  S" THROW#" TSRC-LIB-CALL
  S" TTHEN" TSRC-HOST-EXEC
  ;

: TSRC-SLITERAL  ( -- )
  TSRC-IN-COLON @ 0= IF  S" SLITERAL outside :" TSRC-ERR  THEN
  DEPTH 2 < IF  S" SLITERAL needs c-addr u" TSRC-ERR  THEN
  DUP 0= IF
    NIP DROP
    HERE-D COMP-DATA-ADDR
    0 G,
    EXIT
  THEN
  HERE-D >R
  DUP 0 TSRC-ACC !
  BEGIN TSRC-ACC @ OVER < WHILE
    OVER TSRC-ACC @ + C@ C,-D
    1 TSRC-ACC +!
  REPEAT
  NIP
...
: TSRC-PREVIOUS  ( -- )
  TSRC-IN-COLON @ IF  S" PREVIOUS inside :" TSRC-ERR  THEN
  TWL-# @ 1 > IF
    TWL-ORDER CELL+ TWL-ORDER  TWL-# @ 1- CELLS MOVE
    -1 TWL-# +!
  THEN
  ;
...
: TSRC-GET-ORDER  ( -- )
  0 TSRC-ACC !
  BEGIN TSRC-ACC @ TWL-# @ < WHILE
    TWL-# @ 1- TSRC-ACC @ - CELLS TWL-ORDER + @
    TSRC-IN-COLON @ IF  G,  THEN
    1 TSRC-ACC +!
  REPEAT
  TWL-# @
...
: TSRC-SET-ORDER  ( -- )
  TSRC-IN-COLON @ IF  S" SET-ORDER inside :" TSRC-ERR  THEN
  DEPTH 0= IF  S" SET-ORDER underflow" TSRC-ERR  THEN
  DUP 0< IF  S" SET-ORDER n<0" TSRC-ERR  THEN
  DUP #TWL-ORDER > IF  S" SET-ORDER too many" TSRC-ERR  THEN
  DUP TWL-# !
  DUP 0= IF
    DROP TWL-FORTH TWL-ORDER !  1 TWL-# !  EXIT
  THEN
  0 TSRC-ACC !
  BEGIN TSRC-ACC @ OVER < WHILE
    SWAP
    TSRC-ACC @ CELLS TWL-ORDER + !
    1 TSRC-ACC +!
  REPEAT
  DROP
  ;
...
: TSRC-ORDER  ( -- )
  TSRC-IN-COLON @ IF  S" ORDER inside :" TSRC-ERR  THEN
  TWL-# @ 0= IF  S" (empty)" TYPE CR EXIT  THEN
  0 TSRC-ACC !
  BEGIN TSRC-ACC @ TWL-# @ < WHILE
    TSRC-ACC @ CELLS TWL-ORDER + @ 0 .R SPACE
    1 TSRC-ACC +!
  REPEAT
  CR
  ;
...
: TSRC-PRIM?  ( ca u -- f )
  ...
  2DUP S" DNEGATE" TSRC-EQ IF  2DROP S" DNEG#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" DABS" TSRC-EQ IF  2DROP S" DABS#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" D2*" TSRC-EQ IF  2DROP S" D2STAR#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" M+" TSRC-EQ IF  2DROP S" MPLUS#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" D=" TSRC-EQ IF  2DROP S" DEQ#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" D<" TSRC-EQ IF  2DROP S" DLT#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" -TRAILING" TSRC-EQ IF  2DROP S" NTRAIL#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" /STRING" TSRC-EQ IF  2DROP S" SLSTR#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" COMPARE" TSRC-EQ IF  2DROP S" CMPSTR#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" SEARCH" TSRC-EQ IF  2DROP S" SEARCH#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" BLANK" TSRC-EQ IF
    2DROP BL G, S" FILL#" TSRC-LIB-CALL TRUE EXIT
  THEN
  2DUP S" PARSE" TSRC-EQ IF  2DROP S" PARSE#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" WORD" TSRC-EQ IF  2DROP S" WORD#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" SOURCE" TSRC-EQ IF  2DROP S" SOURCE#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" SOURCE!" TSRC-EQ IF  2DROP S" SRCSET#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" >IN" TSRC-EQ IF
    2DROP TCOM-IN-DADDR COMP-DATA-ADDR TRUE EXIT
  THEN
  2DUP S" ABORT" TSRC-EQ IF
    2DROP -1 G, S" THROW#" TSRC-LIB-CALL TRUE EXIT
  THEN
  2DUP S" ACCEPT" TSRC-EQ IF
    2DROP
    S" OVER#" TSRC-LIB-CALL
    S" TOR#" TSRC-LIB-CALL
    S" ACCEPT#" TSRC-LIB-CALL
    S" FROMR#" TSRC-LIB-CALL
    S" OVER#" TSRC-LIB-CALL
    S" SRCSET#" TSRC-LIB-CALL
    TRUE EXIT
  THEN
  ...
  2DUP S" R/O" TSRC-EQ IF  2DROP 0 G, TRUE EXIT  THEN
  2DUP S" W/O" TSRC-EQ IF  2DROP 1 G, TRUE EXIT  THEN
  2DUP S" R/W" TSRC-EQ IF  2DROP 2 G, TRUE EXIT  THEN
  2DUP S" BIN" TSRC-EQ IF  2DROP TRUE EXIT  THEN
  2DUP S" OPEN-FILE" TSRC-EQ IF  2DROP S" OPENF#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" CREATE-FILE" TSRC-EQ IF  2DROP S" CREATF#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" CLOSE-FILE" TSRC-EQ IF  2DROP S" CLOSE#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" READ-FILE" TSRC-EQ IF  2DROP S" READF#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" WRITE-FILE" TSRC-EQ IF  2DROP S" WRITEF#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" READ-LINE" TSRC-EQ IF  2DROP S" RDLINE#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" WRITE-LINE" TSRC-EQ IF  2DROP S" WRLINE#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" DELETE-FILE" TSRC-EQ IF  2DROP S" UNLINK#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" RENAME-FILE" TSRC-EQ IF  2DROP S" RENAME#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" FILE-SIZE" TSRC-EQ IF  2DROP S" FSIZE#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" FILE-POSITION" TSRC-EQ IF  2DROP S" FPOS#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" REPOSITION-FILE" TSRC-EQ IF  2DROP S" REPOS#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" RESIZE-FILE" TSRC-EQ IF  2DROP S" FTRUNC#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" FLUSH-FILE" TSRC-EQ IF  2DROP S" FLUSHF#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" FILE-STATUS" TSRC-EQ IF  2DROP S" FSTAT#" TSRC-LIB-CALL TRUE EXIT  THEN
  2DUP S" INCLUDE-FILE" TSRC-EQ IF
    2DROP S" INCLUDE-FILE is compile-time only (use INCLUDED / FLOAD)" TSRC-ERR
    TRUE EXIT
  THEN
  2DUP S" INCLUDED" TSRC-EQ IF
    2DROP
    TSRC-IN-COLON @ IF
      S" INCLUDED is compile-time only (FLOAD)" TSRC-ERR
    ELSE
      TSRC-DO-FLOAD
    THEN
    TRUE EXIT
  ...
  2DUP S" BL" TSRC-EQ IF  2DROP 32 G, TRUE EXIT  THEN
  ...
  THEN
  2DUP TSRC-ABORTQ? IF  2DROP TSRC-COMPILE-ABORTQ TRUE EXIT  THEN
  2DUP S" SLITERAL" TSRC-EQ IF  2DROP TSRC-SLITERAL TRUE EXIT  THEN
  2DUP S" GET-ORDER" TSRC-EQ IF  2DROP TSRC-GET-ORDER TRUE EXIT  THEN
  2DUP S" WORDLIST" TSRC-EQ IF  2DROP TSRC-WORDLIST TRUE EXIT  THEN
  2DROP FALSE
  ;
...
: (TSRC-DISPATCH)  ( ca u -- )
  ...
  2DUP S" PREVIOUS" TSRC-EQ IF  2DROP TSRC-PREVIOUS EXIT  THEN
  2DUP S" SET-ORDER" TSRC-EQ IF  2DROP TSRC-SET-ORDER EXIT  THEN
  2DUP S" ORDER" TSRC-EQ IF  2DROP TSRC-ORDER EXIT  THEN
  2DUP S" GET-ORDER" TSRC-EQ IF  2DROP TSRC-GET-ORDER EXIT  THEN
  2DUP S" WORDLIST" TSRC-EQ IF  2DROP TSRC-WORDLIST EXIT  THEN
  ...
  2DUP S" INCLUDED" TSRC-EQ IF  2DROP TSRC-DO-FLOAD EXIT  THEN

...
4880 CONSTANT TCOM-BASE-DADDR         \ 8-aligned (TCOM-IO-END is 4876)
4888 CONSTANT TCOM-HLD-DADDR
4896 CONSTANT TCOM-PIC-DADDR
136 CONSTANT /TCOM-PIC
...
: OPEN-W  ( -- )
  ...
  ;
: TCOM-ARGS-RESERVE  ( -- )
  \ Pin args + I/O scratch + pictured numeric at low daddrs
  0 DP-D !
  TCOM-HANDLER-END ALLOT-D
  10 TCOM-BASE-DADDR !-D
  0 TCOM-FIND-DADDR !-D
  S" BASE" SYM-DATA TCOM-BASE-DADDR SYM-ADD DROP
  [DEFINED] TWL-RESET [IF] TWL-RESET [THEN]
  ;
...
: TARGET-INIT  ( -- )
  ...
  [DEFINED] TLOOP-SP [IF] 0 TLOOP-SP ! 0 TLOOP-DEST ! [THEN]
